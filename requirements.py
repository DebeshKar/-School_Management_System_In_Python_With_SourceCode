...
class SchoolManagementSystem:
    ...
    def show_main_menu(self):
        ...
        tk.Label(self.root, text="Main Menu", font=("Arial", 20)).pack(pady=20)
        tk.Button(self.root, text="Add Student", command=self.show_add_student).pack(pady=10)
        tk.Button(self.root, text="Add Hosteler", command=self.show_add_hosteler).pack(pady=10)
        tk.Button(self.root, text="Add Bus Holder", command=self.show_add_bus_holder).pack(pady=10)
        tk.Button(self.root, text="Add Employee", command=self.show_add_employee).pack(pady=10)
        tk.Button(self.root, text="Record Fee Payment", command=self.show_fee_payment).pack(pady=10)
        tk.Button(self.root, text="Generate Salary Slip", command=self.show_salary_slip).pack(pady=10)
        tk.Button(self.root, text="Generate Report Card", command=self.show_report_card).pack(pady=10)
        tk.Button(self.root, text="Search Students", command=self.show_search_students).pack(pady=10)
        tk.Button(self.root, text="Generate No Dues", command=self.show_no_dues).pack(pady=10)
        tk.Button(self.root, text="Change Password", command=self.show_change_password).pack(pady=10)
        tk.Button(self.root, text="Backup Database", command=self.backup_database).pack(pady=10)
        tk.Button(self.root, text="Restore Database", command=self.restore_database).pack(pady=10)
        tk.Button(self.root, text="Logout", command=self.show_login_screen).pack(pady=10)
    ...
    def show_add_student(self):
        ...
        tk.Button(self.root, text="Save", command=self.save_student).pack(pady=20)
    ...
    def save_student(self):
        ...
        messagebox.showinfo("Success", f"Student added successfully. Username: {username}, Password: {password}")
        self.show_main_menu()
    ...
    def show_add_hosteler(self):
        ...
        tk.Button(self.root, text="Save", command=self.save_hosteler).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_add_bus_holder(self):
        ...
        tk.Button(self.root, text="Save", command=self.save_bus_holder).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_add_employee(self):
        ...
        tk.Button(self.root, text="Save", command=self.save_employee).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_fee_payment(self):
        ...
        tk.Button(self.root, text="Save Payment", command=self.save_fee_payment).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_salary_slip(self):
        ...
        tk.Button(self.root, text="Generate Slip", command=self.save_salary_slip).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_report_card(self):
        ...
        tk.Button(self.root, text="Save Marks", command=self.save_report_card).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_no_dues(self):
        ...
        tk.Button(self.root, text="Generate", command=self.generate_no_dues).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
    ...
    def show_change_password(self):
        ...
        tk.Button(self.root, text="Change Password", command=self.change_password).pack(pady=20)
        tk.Button(self.root, text="Back", command=self.show_main_menu).pack(pady=5)
